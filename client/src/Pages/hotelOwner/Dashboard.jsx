  ...
  return (
    <div className="px-4 py-8 md:px-12 lg:px-20">
      ...
      <div className="flex gap-4 my-8 flex-wrap">
        {/* Total Bookings */}
        <div className="bg-primary/10 border border-primary/20 rounded flex p-4 pr-8 min-w-[250px]">
          <img src={assets.totalBookingIcon} alt="Total Bookings" className="max-sm:hidden h-10" />
          <div className="flex flex-col sm:ml-4 font-medium">
            <p className="text-blue-500 text-lg">Total Bookings</p>
            <p className="text-neutral-600 text-base">{dashboardData.totalBookings}</p>
          </div>
        </div>
        ...
        <div className="bg-primary/10 border border-primary/20 rounded flex p-4 pr-8 min-w-[250px]">
          ...
          <div className="flex flex-col sm:ml-4 font-medium">
            ...
            <p className="text-neutral-600 text-base">${dashboardData.totalRevenue}</p>
          </div>
        </div>
      </div>
