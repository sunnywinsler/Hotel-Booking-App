    ...
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        <div>
            <div className='flex flex-col items-start text-left'>
                ...
                <p className='text-sm md:text-base text-gray-500/90 mt-2'>Take advantage of our limited-time offers and special packages to enhance
            ...
            {roomsDummyData.map((room)=>(
               ...
               {room.amenities.map((item,index)=>(
                <div key={index} className='flex items-centre gap-2 px-3 py-2 rounded-lg bg-[#F5F5FF]/70'>
